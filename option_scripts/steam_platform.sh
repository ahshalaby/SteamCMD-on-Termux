...
echo -e "\nSelect your desired platform:\n\n| Leave empty for default (\033[0;32mWindows\033[0;37m) |\n"
echo -e "1- \033[0;32mWindows\033[0;37m"
echo -e "2- \033[0;32mLinux\033[0;37m"
...
rm pltfrm 2> /dev/null
echo "+@sSteamCmdForcePlatformType linux" >> pltfrm
cd
exit;;
